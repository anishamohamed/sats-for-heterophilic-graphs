...
# Original code from: https://github.com/BorgwardtLab/SAT/blob/main/sat/layers.py
...
class Attention(gnn.MessagePassing):
    ...
    gradient_gating_p (float): gradient gating parameter
    """
...
class StructureExtractor(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.gradient_gating_p = gradient_gating_p
    ...
    def forward(
        self, x, edge_index, edge_attr=None, subgraph_indicator_index=None, agg="sum"
    ):
        x_cat = [x]
